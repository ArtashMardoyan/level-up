...
App-specific conventions for the Level Up web app (React + Vite). The monorepo **router** is the
root [`/CLAUDE.md`](../../CLAUDE.md); shared process lives in [`/.ai/`](../../.ai/) (harnesses,
checklists, `knowledge/frontend-architecture.md`) and the source of truth is [`/docs/`](../../docs/).
This file holds only the frontend's coding conventions.
