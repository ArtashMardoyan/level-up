...
This chat is **built, shipped, and live** (`docs/interview/STATUS.md`). It works over **plain
...
6. **Follow the Interview docs as the standard.** Same layout, depth, and conventions
   (`docs/interview/**`). This package is the sibling technical spec, not a competing one.
...
bilingual/trilingual support — is owned by `docs/interview/**` and is intentionally not re-specified
