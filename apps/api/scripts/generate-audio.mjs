...
// audio/courses/{courseId}/{lang}/{questionId}.mp3. Then `upload-audio.mjs`
// pushes these to S3 and records their keys in the seed course JSON
// (internal/seed/data). See docs/audio/overview.md. Safe to run incrementally.
//
// Usage:
...
const outDir = path.join(scriptDir, '..', 'audio', 'courses')
